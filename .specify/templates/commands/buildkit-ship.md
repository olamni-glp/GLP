...
argument-hint: "[--dry-run] [--json] [--force] [--allow-secrets] [--skip-preflight] [--no-edit] [-m MESSAGE]"
compatibility: "Requires git + gh CLI (authenticated). Needs a buildkit-init'd repo (.specify/feature.json). Honours .specify/ship.json overrides."
metadata:
  author: "buildkit"
