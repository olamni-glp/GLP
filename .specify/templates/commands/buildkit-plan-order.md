...
compatibility: "Requires a git repository + the buildkit PGlite catalog (like /bk-roadmap, /bk-backlog). Reads branches + specs/<feature>/tasks.md; persists run history."
metadata:
  author: "buildkit"
