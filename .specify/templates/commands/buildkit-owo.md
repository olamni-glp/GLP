...
compatibility: "Cross-platform (Windows/Linux/macOS). Stores owo_* rows in the spec-030 machine-registry PGlite catalog under the deploy home. OWL/RDF ingest needs the optional [owo] extra (rdflib): pip install \"buildkit-cli[owo]\" — absent, the tool exits 3 with this hint."
metadata:
  author: "buildkit"
