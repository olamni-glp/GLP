...
argument-hint: "[feature_id of a completed cycle, e.g. 022-buildkit-retrospective]"
compatibility: "Requires a git repository + the buildkit PGlite catalog. Runs on baseline inference air-gapped; the optional [refine] extra only improves the root-cause inference (FR-016)."
metadata:
  author: "buildkit"
