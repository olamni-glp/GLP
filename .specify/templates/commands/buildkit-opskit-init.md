...
compatibility: "Requires a buildkit-initialised project (.specify/) and AWS read-only credentials for the sts/ec2 verify during init. Also needs `pg_dump` on PATH (snapshot-before-mutation refusal otherwise)."
metadata:
  author: "buildkit"
