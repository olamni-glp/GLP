...
compatibility: "Requires a buildkit-initialised project (.specify/), a configured active OpsContext (see /bk-opskit-init), and AWS read-only credentials. Dry-run without --confirm."
metadata:
  author: "buildkit"
