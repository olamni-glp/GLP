...
compatibility: "Requires a buildkit-initialised project (.specify/). AWS calls are read-only (describe/get/list/sts) and only from discover/assess paths with a configured context; catalog access rides buildkit's PGlite."
metadata:
  author: "buildkit"
