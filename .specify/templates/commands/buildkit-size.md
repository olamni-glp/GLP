...
argument-hint: "[init | set <type> <id> (--label <bucket>|--points <n>) | show <type> <id> | history <type> <id> | confirm <type> <id> | decline <type> <id> | prompt <stage> --feature <id> | config-item [suggest|list|confirm|remove] | rollup --feature <id> | tokens [record|report] | scheme [list|show|define|set-active] | summary --feature <id>]"
