...
name: "buildkit-opskit-codexreview"
...
compatibility: "Requires a buildkit-initialised project (.specify/), a git worktree with a reviewable diff, and the codex CLI on PATH. No AWS."
metadata:
  author: "buildkit"
