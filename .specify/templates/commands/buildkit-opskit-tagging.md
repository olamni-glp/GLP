...
compatibility: "Requires a buildkit-initialised project (.specify/). load/certify read the repo's canonical artifact; validate is pure (an explicit --schema file needs no DB at all). No AWS."
metadata:
  author: "buildkit"
