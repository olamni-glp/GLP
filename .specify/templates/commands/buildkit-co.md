...
argument-hint: "[a natural-language situation, or a subcommand: capture|query|detail|case|route|session|import-co|stream|mcp|relocate|backend]"
compatibility: "Requires a git repository + the buildkit PGlite catalog. The compact capture + filter path runs air-gapped; the optional [co] extra (duckdb/pyzmq) adds the DuckLake long-text detail and ZeroMQ live streaming."
metadata:
  author: "buildkit"
